...
def exo_4(chaine: str):
    ...
    return len([c for c in chaine if c.isupper()]), len(
        [c for c in chaine if c.islower()]
    )
...
def exo_7(nombre: int):
    ...
    if nombre % 2 == 0:
        return "Le nombre doit être impair"
...
def exo_10(chaine1: str, chaine2: str):
    ...
    if len(chaine1) != len(chaine2):
        return "Les chaines doivent être de même taille"
