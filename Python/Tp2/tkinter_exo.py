...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.logo_label = customtkinter.CTkLabel(self, text="Nom", font=customtkinter.CTkFont(size=20, weight="bold"))
        self.logo_label.grid(row=0, column=0, padx=20, pady=(20, 10))

        # create main entry and button
        self.entry = customtkinter.CTkEntry(self, placeholder_text="taper le nom du roman")
        self.entry.grid(row=0, column=1, columnspan=2, padx=(20, 0), pady=(20, 10))
